#ifndef CDS_HARAKAX4_H
#define CDS_HARAKAX4_H

#include "context.h"
#include "params.h"

/* Haraka Sponge */
#define haraka_Sx4 CDS_NAMESPACE(haraka_Sx4)
