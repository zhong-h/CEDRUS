...
int main(void)
{
    ...
    //MEASURE("  - WOTS pk gen..    ", (1 << CDS_TREE_HEIGHT), wots_gen_pkx4(wots_pk, &ctx, (uint32_t *) addr));
    ...
    //MEASURE("  - WOTS pk gen..    ", CDS_D * (1 << CDS_TREE_HEIGHT), wots_gen_pkx4(wots_pk, &ctx, (uint32_t *) addr));
