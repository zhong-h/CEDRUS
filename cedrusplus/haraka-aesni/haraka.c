...
void tweak_constants(CDS_ctx *ctx)
{
    ...
    haraka_S(buf, 40*16, ctx->pub_seed, CDS_N, ctx);
...
static void haraka_S_absorb(unsigned char *s, unsigned int r,
                            ...
                            unsigned char p, const CDS_ctx *ctx)
{
    unsigned long long i;
    CDS_VLA(unsigned char, t, r);
...
{
    unsigned long long i;
    CDS_VLA(unsigned char, t0, r);
    CDS_VLA(unsigned char, t1, r);
    CDS_VLA(unsigned char, t2, r);
    CDS_VLA(unsigned char, t3, r);
