...
static void fors_gen_skx4(unsigned char *sk0,
                          unsigned char *sk1,
                          unsigned char *sk2,
                          unsigned char *sk3, const CDS_ctx *ctx,
                            ...
                            uint32_t addr_idx, void *info)
{
    ...
    for (j = 0; j < 4; j++) {
        ...
        set_type(fors_leaf_addrx4 + j*8, CDS_ADDR_TYPE_FORSPRF);
    }
    ...
    for (j = 0; j < 4; j++) {
        set_type(fors_leaf_addrx4 + j*8, CDS_ADDR_TYPE_FORSTREE);
    }

    fors_sk_to_leafx4(leaf + 0*CDS_N,
                  leaf + 1*CDS_N,
                  leaf + 2*CDS_N,
                  leaf + 3*CDS_N,
                  leaf + 0*CDS_N,
               ...
               const uint32_t fors_addr[8])
{
    ...
    for (i = 0; i < CDS_FORS_TREES; i++) {
        ...
        treehashx4(roots + i*CDS_N, sig, ctx,
