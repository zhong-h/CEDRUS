...
#define CDS_SHA256_BLOCK_BYTES 64
#define CDS_SHA256_OUTPUT_BYTES 32  /* This does not necessarily equal CDS_N */

#define CDS_SHA512_BLOCK_BYTES 128
#define CDS_SHA512_OUTPUT_BYTES 64

#if CDS_SHA256_OUTPUT_BYTES < CDS_N
    #error Linking against SHA-256 with N larger than 32 bytes is not supported
#endif

#define CDS_SHA256_ADDR_BYTES 22
...
#define mgf1_256 CDS_NAMESPACE(mgf1_256)
void mgf1_256(unsigned char *out, unsigned long outlen,
          const unsigned char *in, unsigned long inlen);

#define mgf1_512 CDS_NAMESPACE(mgf1_512)
void mgf1_512(unsigned char *out, unsigned long outlen,
          const unsigned char *in, unsigned long inlen);

#define seed_state CDS_NAMESPACE(seed_state)
