...
{
    ((unsigned char *)addr)[CDS_OFFSET_LAYER] = (unsigned char)layer;
}
...
{
    ((unsigned char *)addr)[CDS_OFFSET_TYPE] = (unsigned char)type;
}
...
{
    u32_to_bytes(&((unsigned char *)addr)[CDS_OFFSET_KP_ADDR], keypair);
}
...
{
    memcpy( out, in, CDS_OFFSET_TREE+8 );
    memcpy( (unsigned char *)out + CDS_OFFSET_KP_ADDR, (unsigned char *)in + CDS_OFFSET_KP_ADDR, 4); 
}
...
{
    ((unsigned char *)addr)[CDS_OFFSET_CHAIN_ADDR] = (unsigned char)chain;
}
...
{
    ((unsigned char *)addr)[CDS_OFFSET_HASH_ADDR] = (unsigned char)hash;
}
...
{
    ((unsigned char *)addr)[CDS_OFFSET_TREE_HGT] = (unsigned char)tree_height;
}
