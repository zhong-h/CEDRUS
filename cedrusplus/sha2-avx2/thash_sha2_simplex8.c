             ...
             const CDS_ctx *ctx, uint32_t addrx8[8*8])
{
...
#endif
    unsigned char bufx8[8*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N)];
    unsigned char outbufx8[8*CDS_SHA256_OUTPUT_BYTES];
    unsigned int i;

    for (i = 0; i < 8; i++) {
        memcpy(bufx8 + i*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
                         addrx8 + i*8, CDS_SHA256_ADDR_BYTES);
    }

    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        0*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in0, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        1*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in1, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        2*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in2, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        3*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in3, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        4*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in4, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        5*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in5, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        6*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in6, inblocks * CDS_N);
    memcpy(bufx8 + CDS_SHA256_ADDR_BYTES +
        7*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), in7, inblocks * CDS_N);
    ...
    sha256x8_seeded(
        ...
        /* in */
        bufx8 + 0*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 1*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 2*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 3*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 4*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 5*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 6*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 7*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
...
{
    unsigned char bufx8[8*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N)];
    unsigned char outbuf[4*CDS_SHA512_OUTPUT_BYTES];
    unsigned int i;
    ...
    sha512x4_seeded(
        ...
        1024,                  /* seed length */
        bufx8 + 0*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), /* in */
        bufx8 + 1*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 2*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 3*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        CDS_SHA256_ADDR_BYTES + inblocks*CDS_N /* len */
    ...
    sha512x4_seeded(
        ...
        ctx->state_seeded_512, /* seed */
        1024,                  /* seed length */
        bufx8 + 4*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N), /* in */
        bufx8 + 5*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 6*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        bufx8 + 7*(CDS_SHA256_ADDR_BYTES + inblocks*CDS_N),
        CDS_SHA256_ADDR_BYTES + inblocks*CDS_N /* len */
