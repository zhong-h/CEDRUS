                ...
                const uint32_t addrx8[8*8])
{
    ...
    for (j = 0; j < 8; j++) {
        memcpy(bufx8 + j*(CDS_N + CDS_SHA256_ADDR_BYTES),
                         addrx8 + j*8, CDS_SHA256_ADDR_BYTES);
        memcpy(
            bufx8 + j*(CDS_N + CDS_SHA256_ADDR_BYTES) + CDS_SHA256_ADDR_BYTES,
            ctx->sk_seed,
            CDS_N
        );
    }
    ...
    sha256x8_seeded(
        ...
        /* in */
        bufx8 + 0*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 1*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 2*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 3*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 4*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 5*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 6*(CDS_SHA256_ADDR_BYTES + CDS_N),
        bufx8 + 7*(CDS_SHA256_ADDR_BYTES + CDS_N),
        CDS_SHA256_ADDR_BYTES + CDS_N /* len */
    );
