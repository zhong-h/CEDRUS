...
int main()
{
    ...
    //MEASURE("  - WOTS pk gen 8x.. ", (1 << CDS_TREE_HEIGHT) / 8, wots_gen_pkx8(wots_pk, sk, pk, (uint32_t *) addr));
    ...
    //MEASURE("  - WOTS pk gen x8.. ", CDS_D * (1 << CDS_TREE_HEIGHT) / 8, wots_gen_pkx8(wots_pk, sk, pk, (uint32_t *) addr));
