...
{
    unsigned char bufx8[8 * (CDS_N + CDS_SHA256_ADDR_BYTES)];
    unsigned char outbufx8[8 * CDS_SHA256_OUTPUT_BYTES];
    unsigned int j;

    for (j = 0; j < 8; j++) {
        memcpy(bufx8 + j*(CDS_N + CDS_SHA256_ADDR_BYTES), key, CDS_N);
        memcpy(bufx8 + CDS_N + j*(CDS_N + CDS_SHA256_ADDR_BYTES),
                         addrx8 + j*8, CDS_SHA256_ADDR_BYTES);
    }

    sha256x8(outbufx8 + 0*CDS_SHA256_OUTPUT_BYTES,
             ...
             bufx8 + 0*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 1*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 2*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 3*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 4*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 5*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 6*(CDS_N + CDS_SHA256_ADDR_BYTES),
             bufx8 + 7*(CDS_N + CDS_SHA256_ADDR_BYTES),
