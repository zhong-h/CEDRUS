                          ...
                          uint32_t fors_leaf_addrx8[8*8])
{
    ...
    for (uint32_t i = start; i <= end; i++)
    {
        ...
        fors_next_leafx8(out,out+1*CDS_N,out+2*CDS_N,out+3*CDS_N,out+4*CDS_N,out+5*CDS_N,out+6*CDS_N,out+7*CDS_N,
                            out,out+1*CDS_N,out+2*CDS_N,out+3*CDS_N,out+4*CDS_N,out+5*CDS_N,out+6*CDS_N,out+7*CDS_N,
                            ...
                            uint32_t addr_idx, void *info)
{
    ...
    fors_gen_nodex8(leaf,leaf,1, CDS_FORS_W, pub_seed, fors_leaf_addrx8);
               ...
               const uint32_t fors_addr[8])
{
    ...
    for (i = 0; i < CDS_FORS_TREES; i++)
    {
        ...
        treehashx8(roots + i*CDS_N, sig, sk_seed, pub_seed,
