...
#define CDS_FORS_TREES 11
/* Winternitz parameter, */
#define CDS_WOTS_W_ARRAY {31, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32}
...
#define CDS_WOTS_LEN 27

#define CDS_WOTS_S 418 //(sum(CDS_WOTS_W_ARRAY)-CDS_WOTS_LEN)/2
