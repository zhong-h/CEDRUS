...
int main()
{
    ...
    printf("Parameters: n = %d, h = %d, d = %d, b = %d, k = %d, l = %d w2 = %d\n",
           CDS_N, CDS_FULL_HEIGHT, CDS_D, CDS_FORS_HEIGHT, CDS_FORS_TREES,
           CDS_WOTS_LEN,CDS_FORS_W);

    printf("Running %d iterations.\n", NTESTS);

    MEASURE("Generating keypair.. ", 1, crypto_sign_keypair(pk, sk));
    //MEASURE("  - WOTS pk gen..    ", (1 << CDS_TREE_HEIGHT), wots_gen_pkx1(wots_pk, sk, pk, (uint32_t *) addr));
    ...
    //MEASURE("  - WOTS pk gen..    ", CDS_D * (1 << CDS_TREE_HEIGHT), wots_gen_pkx1(wots_pk, sk, pk, (uint32_t *) addr));
