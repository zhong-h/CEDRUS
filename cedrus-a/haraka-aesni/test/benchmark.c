...
int main()
{
    ...
    //MEASURE("  - WOTS pk gen..    ", (1 << CDS_TREE_HEIGHT), wots_gen_pkx4(wots_pk, sk, pk, (uint32_t *) addr));
    ...
    //MEASURE("  - WOTS pk gen..    ", CDS_D * (1 << CDS_TREE_HEIGHT), wots_gen_pkx4(wots_pk, sk, pk, (uint32_t *) addr));
