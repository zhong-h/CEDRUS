...
#define CDS_WOTS_W_ARRAY {8, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16}
#define CDS_WOTS_LOGW_ARRAY {3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
#define CDS_MAX_WOTS_W 16

#define CDS_WOTS_LEN 32
#define WOTS_ZERO_BITS 1
#define CDS_FORS_ZERO_LAST_BITS 6 
#define WANTED_CHECKSUM  236  /*(SUM_W - CDS_WOTS_LEN) / 2*/
