...
#define CDS_FULL_HEIGHT 67
/* Number of subtree layer. */
#define CDS_D 16
/* FORS tree dimensions. */
#define CDS_FORS_HEIGHT 9
#define CDS_FORS_TREES 35 
/* Winternitz parameter, */

#define CDS_WOTS_W_ARRAY {8, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16}
#define CDS_WOTS_LOGW_ARRAY {3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
#define CDS_MAX_WOTS_W 16

#define CDS_WOTS_LEN 64
#define WOTS_ZERO_BITS 1
#define CDS_FORS_ZERO_LAST_BITS 8
#define WANTED_CHECKSUM  476  /*(SUM_W - CDS_WOTS_LEN) / 2*/
