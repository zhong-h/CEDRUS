...
#define CDS_FORS_TREES 15 
/* Winternitz parameter, */

#define CDS_WOTS_W_ARRAY {64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64}
#define CDS_WOTS_LOGW_ARRAY {6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6}
#define CDS_MAX_WOTS_W 64

#define CDS_WOTS_LEN 31
#define WOTS_ZERO_BITS 6
#define CDS_FORS_ZERO_LAST_BITS 17 
#define WANTED_CHECKSUM  976  /*(SUM_W - CDS_WOTS_LEN) / 2*/
