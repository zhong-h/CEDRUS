...
#define CDS_FULL_HEIGHT 65
/* Number of subtree layer. */
#define CDS_D 19
/* FORS tree dimensions. */
#define CDS_FORS_HEIGHT 7
#define CDS_FORS_TREES 41 
/* Winternitz parameter, */

#define CDS_WOTS_W_ARRAY {8, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16}
#define CDS_WOTS_LOGW_ARRAY {3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
#define CDS_MAX_WOTS_W 16

#define CDS_WOTS_LEN 48
#define WOTS_ZERO_BITS 1
#define CDS_FORS_ZERO_LAST_BITS 10 
#define WANTED_CHECKSUM  356  /*(SUM_W - CDS_WOTS_LEN) / 2*/
