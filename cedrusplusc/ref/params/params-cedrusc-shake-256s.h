...
#define CDS_FORS_HEIGHT 12
#define CDS_FORS_TREES 23 
/* Winternitz parameter, */

#define CDS_WOTS_W_ARRAY {64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64}
#define CDS_WOTS_LOGW_ARRAY {6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6}
#define CDS_MAX_WOTS_W 64

#define CDS_WOTS_LEN 42
#define WOTS_ZERO_BITS 4
#define CDS_FORS_ZERO_LAST_BITS 14
#define WANTED_CHECKSUM  1323  /*(SUM_W - CDS_WOTS_LEN) / 2*/
